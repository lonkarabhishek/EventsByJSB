    ...
    <div className="max-w-6xl mx-auto">
          ...
          <FadeIn key={step.number} delay={i * 0.1}>
            ...
            >
              ...
              <div className="flex flex-col items-center flex-shrink-0 pt-1">
                ...
                >
                  <span className="font-body text-[10px] tracking-[0.05em]" style={{ color: GOLD }}>
                    {step.number}
                  </span>
                </div>
                {/* Connector line */}
              ...
              <div className="flex-1 min-w-0">
                <h3
                  ...
                  style={{ fontSize: "clamp(1.25rem, 2.5vw, 1.75rem)", color: "#e8e0d0" }}
                >
                  {step.title}
                </h3>
                <p
      ...
      <FadeIn delay={0.5}>
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6 mt-12 md:mt-16 pt-10 md:pt-12"
          ...
          <div>
            <p className="font-body text-sm font-light" style={{ color: "rgba(232,224,208,0.45)" }}>
