      ...
      <div className="grid md:grid-cols-2 gap-8 md:gap-12 lg:gap-24 items-center">
        ...
        <FadeIn direction="left">
          <div className="relative">
            ...
            >
              ...
              <p className="font-body text-xs tracking-[0.25em] uppercase mt-1" style={{ color: "rgba(27,46,36,0.45)" }}>
                Dreams Crafted
              </p>
            </div>
          </div>
        ...
        <div>
            ...
            <div className="flex gap-0 divide-x" style={{ borderColor: "rgba(27,58,45,0.15)" }}>
              {stats.map(s => (
                <div key={s.label} className="pr-8 pl-0 first:pl-0 last:pr-0 [&:not(:first-child)]:pl-8">
                  ...
                  <p className="font-body text-[11px] tracking-[0.2em] uppercase mt-1" style={{ color: "rgba(27,46,36,0.42)" }}>
                    {s.label}
                  </p>
                </div>
              ))}
          ...
          <FadeIn delay={0.55}>
            ...
            <p className="font-body text-[10px] tracking-[0.3em] uppercase mt-1 pl-14 md:ml-16" style={{ color: "rgba(27,46,36,0.32)" }}>
