    ...
    <div className="max-w-6xl mx-auto">
      <div className="grid md:grid-cols-2 gap-12 lg:gap-24 items-center">
        ...
        <FadeIn direction="left">
          <div className="relative">
            ...
            <div
              ...
              style={{ background: "rgba(12,10,8,0.94)", border: "1px solid rgba(201,169,110,0.25)", backdropFilter: "blur(12px)" }}
            >
              <p className="font-heading text-4xl font-light" style={{ color: "#c9a96e" }}>200+</p>
              <p className="font-body text-xs tracking-[0.25em] uppercase mt-1" style={{ color: "rgba(232,224,208,0.45)" }}>
                Dreams Crafted
              </p>
            </div>
          </div>
        ...
        <div>
          ...
          {/* Stats */}
          <FadeIn delay={0.48}>
            <div className="flex gap-0 divide-x" style={{ borderColor: "rgba(201,169,110,0.15)" }}>
              {stats.map(s => (
                <div key={s.label} className="pr-8 pl-0 first:pl-0 last:pr-0 [&:not(:first-child)]:pl-8">
                  <p className="font-heading text-3xl md:text-4xl font-light" style={{ color: "#c9a96e" }}>
                    {s.value}
                  </p>
                  <p className="font-body text-[11px] tracking-[0.2em] uppercase mt-1" style={{ color: "rgba(232,224,208,0.4)" }}>
                    {s.label}
                  </p>
                </div>
              ))}
          ...
          <FadeIn delay={0.55}>
            <div className="mt-10 flex items-center gap-4">
              <div className="h-px flex-1 max-w-[48px]" style={{ background: "rgba(201,169,110,0.3)" }} />
              <p className="font-heading text-lg italic" style={{ color: "rgba(201,169,110,0.6)" }}>
                Jagdeep Singh Bagga
              </p>
            </div>
