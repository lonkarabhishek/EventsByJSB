        ...
        <div className="max-w-5xl mx-auto flex flex-col-reverse md:grid md:grid-cols-[1fr_1.65fr] gap-8 md:gap-14 items-start">
          ...
          <FadeIn direction="left">
            <div
              ...
              style={{ background: "rgba(201,169,110,0.04)", border: "1px solid rgba(201,169,110,0.13)" }}
            >
              <div>
              ...
              <div className="space-y-5">
                {[
                  {
                    icon: <Phone className="w-[15px] h-[15px]" />, label: "Phone",
                  ...
                  {
                    icon: <MessageCircle className="w-[15px] h-[15px]" />, label: "WhatsApp",
                  ...
                  {
                    icon: <Mail className="w-[15px] h-[15px]" />, label: "Email",
                  ...
                  {
                    icon: <MapPin className="w-[15px] h-[15px]" />, label: "Office",
                    content: (
                      <>
                  ...
                  {
                    icon: <Clock className="w-[15px] h-[15px]" />, label: "Hours",
                    content: (
                      <>
              ...
              <div>
                ...
                <div className="flex gap-3">
                  {[
                    { href: "https://instagram.com/eventsbyjsb", icon: <Instagram className="w-3.5 h-3.5" /> },
                    {
                    ...
                    <a
                      ...
                      onMouseLeave={e => { const el = e.currentTarget as HTMLElement; el.style.borderColor = `${GOLD}22`; el.style.color = "rgba(232,224,208,0.4)"; }}
                    >
                      {icon}
                    </a>
                  ))}
